...
<head>
	<meta charset="utf8">
	<link rel="stylesheet" type="text/css" href="css/stylesaida.css">
	 <meta charset="utf-8">
...
<div class="panel panel-success">
	...
	<form action="add_itemsaida.php"  method="post">
	...
	<td>
		...
		<select name="loja" id="loja" required>
			...
			while ($list_loja = mysql_fetch_array($sql_loja)) {			
				...
				echo "<option value='$cod_loja'>$descricao</option>";
			}
			?>
...
<td align="right">
		...
		<input type="text" name="total" id="total" required placeholder="Informe o Valor" onKeyUp="maskIt(this,event,'###.###.###,##',true)">
