...
$situacao='disabled';
  ...
  ?>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      	$sql = "select loja.idLoja,
                                                       ...
                                                       loja.tel
                                                  from loja
                                                  join cidade on (cidade.idCidade = loja.idCidade)";
	...
	echo "
      ...
      <td> $telefone </td>
    <center>  
    <td align=center> <a href=editaloja.php?codigo=$codigo data-toggle=modal data-target=#myModal>
