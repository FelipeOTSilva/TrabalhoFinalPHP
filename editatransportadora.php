...
$sql = "SELECT * FROM transportadora WHERE idTransportadora ='$codigo'";

      $editar = mysql_query($sql);
      list($codigo,$cidade,$nome,$endereco,$numero,$bairro,$cep,$cnpj,$inscricao,$contato,$telefone) = mysql_fetch_row($editar);
  ...
  ?>
   ...
   <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form name="formulario"  action="atualizartransportadora.php"  method="POST" role="form">
                                        <div class="panel-body">
                       	...
                       	<br>
							            ...
							            <br>
							                           	...
							                           	<a href="<?php echo "excluirtransportadora.php?codigo=$codigo";?>">
