 ...
 include "conecta.php";
    ...
    $sql="insert into fornecedor(idCidade,fornecedor,endereco,num,bairro,cep,contato,cnpj,insc,tel) values ('$cidade', '$nome', 
          '$endereco', '$num', '$bairro', '$cep', '$contato', '$cnpj', '$insc', '$telefone')";
    if(mysql_query($sql)){
        echo "<script>alert('Cadastro Efetuado com Sucesso');</script>";
        echo "<script>window.location='cad_fornecedor.php';</script>";        
    }
    else{
