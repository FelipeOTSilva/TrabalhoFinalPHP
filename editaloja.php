...
$sql = "SELECT * FROM loja WHERE idLoja ='$codigo'";

      $editar = mysql_query($sql);
      list($codigo,$cidade,$nome,$endereco,$numero,$bairro,$telefone,$inscricao,$cnpj) = mysql_fetch_row($editar);
  ...
  ?>
   ...
   <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form name="formulario"  action="atualizarloja.php"  method="POST" role="form">
                                        <div class="panel-body">
                                        ...
                                        <label>Loja</label><br>
							                           	<input type="tex" name="loja" id="loja" value="<?php echo $nome ?>" disabled>
							            <br>
                       	...
                       	<br>
							            ...
							            <br>
							                           	...
							                           	<a href="<?php echo "excluirloja.php?codigo=$codigo";?>">
